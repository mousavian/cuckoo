...
def main():
    ...
    parser.add_argument("--platform", type=str, action="store", default="windows", help="Specify the operating system platform you want to use (windows/android)", required=False)
